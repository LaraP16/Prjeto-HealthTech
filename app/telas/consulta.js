        ...
        <ScrollView>
            <View style={styles.container}>
                ...
                <View style={styles.consulta}>
                    <Image source={require("../../src/images/mulher.png")} style={styles.imagem} />
                ...
                <View style={styles.consult}>
                    <Image source={require("../../src/images/homem.png")} style={styles.imagem} />
                    <View style={styles.textContainer}>
                ...
                <View style={styles.consult}>
                    <Image source={require("../../src/images/mulher2.png")} style={styles.imagem} />
                    <View style={styles.textContainer}>
